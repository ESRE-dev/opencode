...
**Next:** [Chapter 13: MCP & ACP Protocols →](./13-mcp-and-acp.md) — Model Context Protocol for external tools and Agent Client Protocol for agent interop.

**Previous:** [Chapter 11: HTTP Server & API](./11-http-server-and-api.md)
