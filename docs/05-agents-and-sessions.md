# Chapter 5: Agent & Session Architecture
...
The snapshot system (covered in [Chapter 7](./07-database-and-storage.md)) tracks file states at each message boundary, making this possible without version control.
...
**Next:** [Chapter 6: Tool System →](./06-tool-system.md) — The 25+ built-in tools and how permissions govern execution.

**Previous:** [Chapter 4: LLM Provider System](./04-llm-providers.md)
