---
title: "Chapter 14: SDK & Plugin System"
---
...
MCP servers can be written in any language and provide tools via the standard MCP protocol. See [Chapter 13: MCP & ACP Protocols](/13-mcp-and-acp/) for details.
...
**Next:** [Chapter 15: Build & Release Pipeline →](/15-build-and-release/) — Cross-compilation, the publish script, and CI/CD workflows.

**Previous:** [Chapter 13: MCP & ACP Protocols](/13-mcp-and-acp/)
