...
**Next:** [Chapter 7: Database & Storage →](/07-database-and-storage/) — SQLite, Drizzle ORM, event-sourced messages, and migration strategies.

**Previous:** [Chapter 5: Agents & Sessions →](/05-agents-and-sessions/)
