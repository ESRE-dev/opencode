---
title: "Chapter 3: The Core Package"
---
...
The provider module is the adapter layer between OpenCode's agent system and the 20+ LLM providers. It's covered in detail in [Chapter 4: LLM Provider System](/04-llm-providers/), but here's the quick summary:
...
See [Chapter 7: Database & Storage](/07-database-and-storage/) for the full schema walkthrough.
...
See [Chapter 12: Event Bus System](/12-event-bus/) for the complete architecture.
...
See [Chapter 13: MCP & ACP Protocols](/13-mcp-and-acp/) for the full implementation details.
...
The TUI is the default command — when you type `opencode` with no arguments, it launches a full terminal user interface built with SolidJS and `@opentui/solid`. The TUI is covered in depth in [Chapter 8: Terminal UI](/08-terminal-ui/).
...
**Next:** [Chapter 4: LLM Provider System](/04-llm-providers/) — How OpenCode abstracts 20+ AI providers through the Vercel AI SDK.

**Previous:** [Chapter 2: Runtime & Toolchain](/02-runtime-and-toolchain/)
