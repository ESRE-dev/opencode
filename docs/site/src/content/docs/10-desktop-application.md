---
title: "Chapter 10: Desktop Application"
---
...
**Next:** [Chapter 11: HTTP Server & API →](/11-http-server-and-api/) — Hono-powered API, OpenAPI generation, and the SSE event stream.

**Previous:** [Chapter 9: Web Application](/09-web-application/)
