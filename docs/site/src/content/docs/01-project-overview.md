...
- **[Chapter 2: Runtime & Toolchain →](/02-runtime-and-toolchain/)** — Understanding Bun, TypeScript, and the build system
- **[Chapter 3: The Core Package →](/03-core-package/)** — Exploring the engine that powers everything
